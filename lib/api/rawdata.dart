...
Student errorStudent = Student.fromJson({
  'age': 0,
  'img_url': '',
  'state_id': 0,
  'birthday': '',
  'schedule_link': 'https://example.com',
  'name': 'The App Encountered an Error.',
  'grade': 0,
  'locker': 'If relogging does not work, log out and reinstall the app.',
  'counselor_name': 'Please log out and try again.',
  'id': 0,
  'image64': "",
  'assignments': {},
  'grades': {}
...
Map<String, Map<String, dynamic>> errorGrades = {
  'App Error': {
    'grade': 0.0,
    'teacher_name': 'Please log out and login again',
    'teacher_email':
        'If the issue continues please log out THEN reinstall the app'
  },
  'App Error?!': {
    'grade': 0.0,
    'teacher_name': 'Please log out and login again',
...
ScheduleAssignmentsList errorScheduleAssignments =
    ScheduleAssignmentsList.fromJson({'scheduleAssignments': []});
